...
This repository contains my solutions to various LeetCode Hard problems. Each problem is carefully analyzed and implemented with optimal time and space complexity.

## 🚀 Solved Problems

| # | Problem Title | Difficulty | Status |
|---|---------------|------------|--------|
| 4 | [Median of Two Sorted Arrays](https://leetcode.com/problems/median-of-two-sorted-arrays/) | Hard | ✅ Solved |
| 23 | [Merge k Sorted Lists](https://leetcode.com/problems/merge-k-sorted-lists/) | Hard | ✅ Solved |
| 25 | [Reverse Nodes in k-Group](https://leetcode.com/problems/reverse-nodes-in-k-group/) | Hard | ✅ Solved |
| 32 | [Longest Valid Parentheses](https://leetcode.com/problems/longest-valid-parentheses/) | Hard | ✅ Solved |
| 37 | [Sudoku Solver](https://leetcode.com/problems/sudoku-solver/) | Hard | ✅ Solved |
| 41 | [First Missing Positive](https://leetcode.com/problems/first-missing-positive/) | Hard | ✅ Solved |
...
| 127 | [Word Ladder](https://leetcode.com/problems/word-ladder/) | Hard | ✅ Solved |
...
## 🛠️ Tools Used
- Languages: C++ / Python / Java (as applicable)
- Platform: [LeetCode](https://leetcode.com/)
- Version Control: Git & GitHub

## 📈 Stats
![LeetCode Stats](https://leetcard.github.io/stats?username=Nithwin&theme=dark)
